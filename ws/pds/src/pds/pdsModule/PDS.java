...
import pds.common.*;
import pds.common.InputData.ExperimentNotCreated;
...
public class PDS  {
	 ...
	 * the output results.
	 * 
	 * @param experiment is the experiment object with the data needed to configure
	 *                   and run the simulation
	 * @return returns the ResultsFile object with the names of all the requested
	 *         resulting data files generated. If any of those files could not be
	 *         generated the corresponding string would be a null reference. It
	 *         returns null if the simulation is in an inadequate state to be
	 *         started in an uninterruptible way.
	 */



	/**
	 * This operation runs a simulation of the given experiment up to completion and
	 * produces the output results. If it is running in a concurrent thread it can
	 ...
	 *         reference.
	 */
	private pds.common.ResultsFiles simulate(pds.common.InputData experiment) {
	...
	/**
	 * Main program that runs the particle dynamic simulation
	 */

	public static void main(String[] args) throws ExperimentNotCreated {

		String nomFich = "InputFile";
