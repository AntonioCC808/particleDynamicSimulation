...
public class R3Point extends R2Point implements Cloneable {
	...
	/**
	 * Calculates the distance between two points in R3 space (module of the
	 * difference)
	 * 
	 * @param the point to which the distance will be calculated
	 * @return the module of the distance between this and the point given as
	 *         argument, it is returned as a double value.
	 * 
	 */
	 ...
	 * 
	 * @return the kinetic energy of the particle, it is returned as a double value.
	 * 
	 */
