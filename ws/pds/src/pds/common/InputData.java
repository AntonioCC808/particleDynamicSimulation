...
/**
 * Container of all the information needed to perform the simulation. It reads
 * the data from the text file passed as parameter.
 */
public class InputData {
	...
	/**
	 * Simulation identifier, the name of the element.
	 */
	public String nickname;

	/**
	 * Parameter with length dimension of the biparametric potential. Sigma for the
	 * Lennard-Jones potential, which is the distance for which the potential
	...
	/**
	 * Reduce density of the bulk of atoms.
	 */
	...
	/**
	 * Number of segments in the X axis used for the various histograms plotted as
	 * results of the simulation. This number is also used as the number of values
	 * of distance used to generate the image of the potential.
	 */
	public int histogramResolution;

	/**
	 * This is the length of the edge of the unit cell. It is calculated as with the
	 * reduce density and the sigma parameter
	 */
	public double latcon;


	/**
	 * List of data collected from each step of the simulation. It has the values of
	 * the kinetic and potential energies at each step of the simulation.
	 */
	public List<EnergyLog> energyLog;

	/**
	 * List of states that will be used for creating the animation. Only a fraction
	 * of the steps is stored in this list, and only a fraction of the lattice is
	...
	/**
	 * 
	 * This reference serve to provide the InitialVelocityDistribution graph to the
	 * output module.
	 * 
	 */
	...
	/**
	 * 
	 * This reference serve to provide the force graph to the output module.
	 * 
	 */
	...
	/**
	 * 
	 * This reference serve to provide the PairDistributionFunction graph to the
	 * output module.
	 * 
	 */
	 ...
	 * 
	 * @param simulationData a string with the full path of the file that gives
	 *                       values to all the attributes of the object.
