...
import java.util.*;
/**
 * This class calculates the current neighbors lists for all particles.
 */
@SuppressWarnings("unused")
public class Neighbours implements pds.common.INeighbours {
  /**
   * The state for which the vicinities of all particles are calculated.
   * This value is initialized by the constructor.
   */
  protected pds.common.State s;

  /**
   * This static method returns a Neighbors object that implements the interface INeighbours
   * 
  ...
  /**
   * This constructor receives the state for which the Neighbors object
   * will be created.
   * 
   * @param s the state for whose particles the vicinity will be calculated when needed
   */
