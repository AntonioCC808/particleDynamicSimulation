...
public class ResultsFiles {
  ...
  /**
   * This constains the name of the text file to be readen by xCryDen to generate the position movie.
   */
   ...
   * 	@param prefix This is the name of the directory (absolute), and includes the last "\" symbol for the folder, as an string.
 ...
 */
  ...
  /**
   * 
   * Name of the text file with the initial positions of the atoms
   */
  ...
  /**
   * Name of the text file with the potential and the force 
   * isted together
   */
